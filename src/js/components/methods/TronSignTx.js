...
import * as TronSignTxActions from '../../actions/methods/TronSignTxActions';

import Response from './common/Response';

const TronSignTx = (props): any => {
    ...
    return (
        <section className="method-content">
            ...
            <div className="method-params">
                ...
                <div className="row">
                    <label></label>
                    <button onClick={ event => onSignTx() }>Sign Tron transaction</button>
                </div>
            </div>
...
export default connect(
    (state: State) => {
        return {
            common: state.common,
            state: state.tronsigntx,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(TronSignTxActions, dispatch),
        };
    }
)(TronSignTx);
