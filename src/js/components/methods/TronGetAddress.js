...
import * as TronGetAddressActions from '../../actions/methods/TronGetAddressActions';

import Response from './common/Response';

const TronGetAddress = (props): any => {
...
export default connect(
    (state: State) => {
        return {
            common: state.common,
            state: state.trongetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(TronGetAddressActions, dispatch),
        };
    }
)(TronGetAddress);
