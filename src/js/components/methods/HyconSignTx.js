...
import * as HyconSignTxActions from '../../actions/methods/HyconSignTxActions';

import Response from './common/Response';

const HyconSignTx = (props): any => {
    ...
    return (
        <section className="method-content">
            ...
            <div className="method-params">
                ...
                <div className="row">
                    <label></label>
                    <button onClick={ event => onSignTx() }>Sign Hycon transaction</button>
                </div>
            </div>
...
export default connect(
    (state: State) => {
        return {
            common: state.common,
            state: state.hyconsigntx,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(HyconSignTxActions, dispatch),
        };
    }
)(HyconSignTx);