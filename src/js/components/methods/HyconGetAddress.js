...
import * as HyconGetAddressActions from '../../actions/methods/HyconGetAddressActions';

import Response from './common/Response';

const HyconGetAddress = (props): any => {
    const {
        response,
        tab,
        code,
...
export default connect(
    (state: State) => {
        return {
            common: state.common,
            state: state.hycongetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(HyconGetAddressActions, dispatch),
        };
    }
)(HyconGetAddress);